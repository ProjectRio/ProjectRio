...
ConnectionError NetPlayServer::OnConnect(ENetPeer* incoming_connection, sf::Packet& received_packet)
{
  ...
  SendResponseToPlayer(new_player, MessageID::RankedBox, Config::Get(Config::NETPLAY_RANKED));

  // send Game Mode state
  SendResponseToPlayer(new_player, MessageID::GameMode, Config::Get(Config::NETPLAY_GAME_MODE));
